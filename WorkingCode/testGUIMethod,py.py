...
class Test_GUI_Methods(unittest.TestCase):
    ...
    def test_validClick(self):
        ...
        self.assertEqual(g.validClick(699,500),False)
        self.assertEqual(g.validClick(1,1),False)
        self.assertEqual(g.validClick(5,500),False)
        self.assertEqual(g.validClick(300,699),False)
